...
**Evolved Into:** [ADR-0007: Audio Perception](ADR-0007-audio-perception.md) — the cochlear model was refined into a leaner perceptual pipeline with orthogonal codebook projection
