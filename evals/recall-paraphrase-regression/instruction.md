Run the Kannaka paraphrase recall probe suite.
...
status, into `/app/rollout.json`, along with binary provenance (path, sha256, --version
output) and the sha256 of the store copy used.
